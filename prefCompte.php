  ...
  <body>
    ...
    <!-- Brand and toggle get grouped for better mobile display -->
      ...
      <div class="container"><br><br><br>
          ...
          <input class="form-control" type="password" name="oldmdp" required /></p><br>
          <p>Saisissez votre nouveau mot de passe: <br>
              <input class="form-control" type="password" name="newmdp" required /></p><br>
          <p>Saisissez à nouveau votre mot de passe: <br>
              <input class="form-control" type="password" name="newmdp2" required /></p><br>
